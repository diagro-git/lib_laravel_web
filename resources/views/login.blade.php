...
<div class="container h-100">
    <div class="row h-100 justify-content-center align-items-center">
        ...
        <span class="fa-stack fa-4x" style="position:relative; top:-170px;left:38%;z-index:2;">
        ...
        <div class="col-8" style="background:white;padding:60px;border-radius:10px;box-shadow:0 0 14px 0 rgba(0,0,0,0.2);">
            ...
            <form class="form" method="post" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" @class(['form-control', 'is-invalid' => $errors->has('password')])>
                    @error('email')
